      ...
      {pricingTiers.map((item, index) => {
        ...
        return (
          ...
          >
            ...
            {vehicle === 'car' ? <Ionicons name='car-sharp' size={26} color="#2563EB" /> : <MaterialIcons name='electric-rickshaw' size={26} color="#2563EB" />}
            <Text style={styles.cardTitle}>{vehicle === 'car' ? 'Car' : 'Auto'}</Text>
